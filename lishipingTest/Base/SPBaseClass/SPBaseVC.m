...
- (void)loadView
{
    ...
    //2.IOS7中默认是YES，当滚动页面的时候我们隐约能在导航栏下面看到我们页面的视图：
    //3.但是当我们设置一张不透明的图片作为导航栏背景时,该属性就会变成NO,这样不透明以后我们可以人为设置成YES达到延伸至导航栏的效果
    self.extendedLayoutIncludesOpaqueBars = NO;//默认
    ...
    self.automaticallyAdjustsScrollViewInsets = NO;//非系统默认
